...
public class Ubicaciones extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lat = intent.getDoubleExtra("Latitud",19.4324501);
        lon = intent.getDoubleExtra("Longitud",-99.1333817);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(ubicacion).title("Ubicación famosa"));
